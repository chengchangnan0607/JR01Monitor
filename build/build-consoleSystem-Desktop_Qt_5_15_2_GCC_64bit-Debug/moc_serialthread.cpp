...
#include <memory>
#include "../../src/BL/COMM/serialthread.h"
...
QT_MOC_LITERAL(1, 13, 9), // "sRecvData"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 4) // "data"

    },
    "SerialThread\0sRecvData\0\0data"
};
...
void SerialThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sRecvData((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialThread::sRecvData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialThread::sRecvData(QByteArray _t1)
{
